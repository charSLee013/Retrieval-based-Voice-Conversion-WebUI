...
def vc_single(
    ...
    protect=protect0
    sid=spk_item
    if input_audio_path is None and input_audio_path2 is None:
        return "You need to upload an audio", None
    if(input_audio_path2):input_audio_path=input_audio_path2####有录音优先用录音
    ...
    with gr.Tabs():
        with gr.TabItem("Demo"):
            gr.Markdown(
                ...
                预置变声音色：日本开源活力女声骏达萌(zundamon)
                
                demo video: https://www.bilibili.com/video/BV1pm4y1z7Gm
                
                UP主: 花儿不哭
                
                github主页：https://github.com/RVC-Project/Retrieval-based-Voice-Conversion-WebUI
            ...
            #     outputs=[spk_item],
            # )
            get_vc("three_moon_e20_s10000.pth")
            with gr.Row():
                vc_input3 = gr.Audio(label="上传音频文件(如果有录音优先转录音)")
                vc_input4 =gr.Microphone(label="点击录音")
...
app.launch(server_name="127.0.0.1",server_port=4435)